...
- The microscopy phase problem &rarr; solved using proximal gradient methods:
  - "Fourier" projection (forward model &rarr; reproduces data)
  - "Overlap" projection (reconstructed sample self-consistent with adjacent scanning positions)
