...
- Electron probe scanned across sample, acquiring phase-shifts
  - Diffracted beam _intensity_ collected on detector &rarr; phase problem
- Reconstructing sample potential from diffraction intensities &rarr; non-convex inverse problem
